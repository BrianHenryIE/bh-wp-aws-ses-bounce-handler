...
interface SES_Bounce_Handler_Integration_Interface {
	...
	/**
	 * Used to determine if the integration should be hooked to the notifications and if it should be used in the
	 ...
	 *
	 * @param array<string, string> $test_data Earlier saved references to objects that will change, and their state.
	 *
	 * @return array<string, mixed> {bool: success, string: html}
	 */
	 ...
	 *
	 * @param array<mixed, mixed> $test_data The data created and saved during setup_test().
	 *
	 * @return bool
	 */
